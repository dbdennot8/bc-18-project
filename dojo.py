    ...
    def create_room(self, room_type, room_name):
        ...
        if room_type == "office":
            if room_name in self.all_office_names:
                ...
                print("The office named {0:s} has been created".format(room_name))
            ...
            if room_name in self.all_living_space_names:
                ...
                print("The living space named {0:s} has been created".format(room_name))
        else:
    ...
    def add_person(self, person_type, first_name, surname, wants_accommodation="n"):
        ...
        if person_type == "fellow" or person_type == "staff":
            if person_type == "fellow":
                ...
                print("Fellow {0:s} {1:s} has been successfully added".format(first_name, surname))
                ...
                if len(self.all_offices) == 0:
                    print("Office not assigned, because no offices are available at this time.")
                else:
                    random_office = random.choice(self.all_offices)
                    if len(random_office.occupants) >= 6:
                        print("The office " + str(random_office.room_name) + " is filled to capacity.")
                        random_office = random.choice(self.all_offices)
                    else:
                ...
                if new_person.wants_accommodation == "yes" or new_person.wants_accommodation == "y":
                    if len(self.all_living_spaces) == 0:
                        print("Living space not assigned, because no living spaces are available at this time.")
                    else:
                        random_living_space = random.choice(self.all_living_spaces)
                        if len(random_living_space.occupants) >= 4:
                            print("The living space " + str(random_living_space.room_name) + " is filled to capacity.")
                            random_living_space = random.choice(self.all_living_spaces)
                        else:
                ...
                new_person = Staff(person_type, first_name, surname, wants_accommodation)
                self.all_persons.append(new_person)
                self.staff.append(new_person)
                print("Staff {0:s} {1:s} has been successfully added".format(first_name, surname))

                """The following assigns an office to a new staff member"""
                if len(self.all_offices) == 0:
                    print("Office not assigned, because no offices are available at this time.")
                    if new_person.wants_accommodation == "yes" or new_person.wants_accommodation == "y":
